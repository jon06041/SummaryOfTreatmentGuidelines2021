...
const MyComponent = () => {
  ...
  return (
    ...
    <List.Section title="Treatment Options">
      ...
      <List.Accordion
        title="Infant and children <45 kg4 (nasopharynx, urogenital, and rectal)"titleNumberOfLines={4}
        left={props => <List.Icon {...props} icon="folder" />}>
        
        <List.Item  title='Recommended Regimens' />
        <View>
          <Text NumberOfLines={4}>
          erythromycin base, 50 mg/kg body weight/day orally, divided into 4 doses daily for 14 days OR
          </Text>
        </View>
        <List.Item  />
        <View>
          <Text NumberOfLines={4}>
          ethylsuccinate, 50 mg/kg body weight/day orally, divided into 4 doses daily for 14 days
          </Text>
        </View>
      ...
      <List.Accordion
        title="Children who weigh ≥45 kg, but who are aged <8 years (nasopharynx, urogenital, and rectal)"titleNumberOfLines={4}
        left={props => <List.Icon {...props} icon="folder" />}>
      ...
      <List.Accordion
        title="Children aged ≥8 years (nasopharynx, urogenital, and rectal)"titleNumberOfLines={4}
        left={props => <List.Icon {...props} icon="folder" />}>
      ...
      <List.Accordion
        title="Neonates:5 ophthalmia and pneumonia"titleNumberOfLines={4}
        left={props => <List.Icon {...props} icon="folder" />}>
        <List.Section>
          <List.Accordion
        title="Recommended Regimens"
