  ...
  return (
    <List.Section title="Treatment Options">
      <List.Accordion
        ...
        <View>
          <Text>
          metronidazole gel 0.75%, one 5 gm applicator intravaginally, 1x/day for 5 days OR
          </Text>
        </View>
        <List.Item  />
        <View>
      ...
      <List.Accordion
        ...
        <View>
          <Text>
          clindamycin 300 mg orally 2x/day for 7 days OR
          </Text>
        </View>
        <List.Item  />
        <View>
        ...
        <View>
          <Text>
          secnidazole 2 gm orally in a single dose<Text style={{fontSize: 8, lineHeight: 37}}>2</Text> OR
          </Text>
        </View>
       < List.Item  />
        <View>
          <Text>
          tinidazole 2 gm orally 1x/day for 2 days OR
          </Text>
        </View>
        <List.Item  />
        <View>
          <Text>
          tinidazole 1 gm orally 1x/day for 5 days
          </Text>
        </View>
